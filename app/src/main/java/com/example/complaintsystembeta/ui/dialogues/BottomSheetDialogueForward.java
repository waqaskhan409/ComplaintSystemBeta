...
import com.example.complaintsystembeta.ui.complaints.ComplainForwarding;
import com.example.complaintsystembeta.ui.complaints.ComposeComplaints;
import com.google.android.material.bottomsheet.BottomSheetDialogFragment;

public class BottomSheetDialogueForward extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        linearLayoutGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((ComplainForwarding)getActivity()).gallery();
                dismiss();
            }
        });
        linearLayoutCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((ComplainForwarding)getActivity()).camera();
                dismiss();
            }
        });
